...
class TestMiniMaxCloudIntegration:
    ...
    def test_m25_highspeed_basic_chat(self, engine: CloudEngine) -> None:
        """Send a simple message and verify we get a non-empty response."""
    ...
    def test_m25_highspeed_health(self, engine: CloudEngine) -> None:
        """Engine health should be True when MINIMAX_API_KEY is set."""
        assert engine.health() is True

    def test_m25_highspeed_list_models(self, engine: CloudEngine) -> None:
