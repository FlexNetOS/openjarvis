...
class TestMiniMaxPricing:
    ...
    def test_minimax_cost_estimate(self) -> None:
        # MiniMax-M2.5: $0.30/M in, $1.20/M out
        cost = estimate_cost("MiniMax-M2.5", 1_000_000, 1_000_000)
        assert cost == pytest.approx(1.50)

    def test_minimax_highspeed_cost_estimate(self) -> None:
        # MiniMax-M2.5-highspeed: $0.60/M in, $2.40/M out
        cost = estimate_cost("MiniMax-M2.5-highspeed", 1_000_000, 1_000_000)
        assert cost == pytest.approx(3.00)

    def test_zero_tokens_zero_cost(self) -> None:
        assert estimate_cost("MiniMax-M2.5", 0, 0) == 0.0
